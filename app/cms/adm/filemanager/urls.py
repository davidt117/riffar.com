...
from views import (FilemanagerCreateFolderView, FilemanagerFileListView,
                   FilemanagerFolderListView, FilemanagerIndexView,
                   FilemanagerRemoveFileView, FilemanagerRemoveFolderView,
                   FilemanagerRenameFolderView, FilemanagerSendFileView)
